...
export declare class Context {
    ...
    get chat(): tt.Chat.ChannelChat | tt.Chat.PrivateChat | tt.Chat.GroupChat | tt.Chat.SupergroupChat | undefined;
    ...
    editMessageLiveLocation(latitude: number, longitude: number, markup?: tt.InlineKeyboardMarkup): Promise<true | (tt.Update.Edited & tt.Message.LocationMessage)>;
    ...
    replyWithMediaGroup(...args: Shorthand<'sendMediaGroup'>): Promise<(tt.Message.PhotoMessage | tt.Message.VideoMessage)[]>;
    ...
    replyWithMarkdown(markdown: string, extra?: tt.ExtraEditMessage): Promise<tt.Message.TextMessage>;
    replyWithMarkdownV2(markdown: string, extra?: tt.ExtraEditMessage): Promise<tt.Message.TextMessage>;
    replyWithHTML(html: string, extra?: tt.ExtraEditMessage): Promise<tt.Message.TextMessage>;

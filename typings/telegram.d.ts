...
declare class Telegram extends ApiClient {
     ...
     */
    getFileLink(fileId: string | tt.File): Promise<string>;
     ...
     */
    setWebhook(url: string, certificate?: tt.InputFile, maxConnections?: number, allowedUpdates?: readonly tt.UpdateType[]): Promise<true>;
     ...
     */
    sendMessage(chatId: number | string, text: string, extra?: tt.ExtraEditMessage): Promise<tt.Message.TextMessage>;
    /**
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendPhoto(chatId: number | string, photo: tt.InputFile, extra?: tt.ExtraPhoto): Promise<tt.Message.PhotoMessage>;
    /**
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendDocument(chatId: number | string, document: tt.InputFile, extra?: tt.ExtraDocument): Promise<tt.Message.DocumentMessage>;
    /**
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendAudio(chatId: number | string, audio: tt.InputFile, extra?: tt.ExtraAudio): Promise<tt.Message.AudioMessage>;
    /**
     * Send .webp stickers
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendSticker(chatId: number | string, sticker: tt.InputFile, extra?: tt.ExtraSticker): Promise<tt.Message.StickerMessage>;
    /**
     * Send video files, Telegram clients support mp4 videos (other formats may be sent as Document)
     * Bots can currently send video files of up to 50 MB in size, this limit may be changed in the future.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendVideo(chatId: number | string, video: tt.InputFile, extra?: tt.ExtraVideo): Promise<tt.Message.VideoMessage>;
    /**
     * Send .gif animations
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendAnimation(chatId: number | string, animation: tt.InputFile, extra?: tt.ExtraAnimation): Promise<tt.Message.AnimationMessage>;
    /**
     * Send video messages
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendVideoNote(chatId: number | string, videoNote: tt.InputFileVideoNote, extra?: tt.ExtraVideoNote): Promise<tt.Message.VideoNoteMessage>;
    /**
     * Send audio files, if you want Telegram clients to display the file as a playable voice message. For this to work, your audio must be in an .ogg file encoded with OPUS (other formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendVoice(chatId: number | string, voice: tt.InputFile, extra?: tt.ExtraVoice): Promise<tt.Message.VoiceMessage>;
    /**
     ...
     */
    sendMediaGroup(chatId: number | string, media: ReadonlyArray<tt.InputMediaPhoto | tt.InputMediaVideo>, extra?: tt.ExtraMediaGroup): Promise<(tt.Message.PhotoMessage | tt.Message.VideoMessage)[]>;
    /**
     * Send a native poll.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
    ...
    setChatPhoto(chatId: number | string, photo: tt.InputFile): Promise<true>;
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    unpinChatMessage(chatId: number | string): Promise<true>;
    /**
    ...
    answerCbQuery(callbackQueryId: string, text?: string, showAlert?: boolean, extra?: {
        cache_time?: number;
    }): Promise<true>;
    ...
    setStickerSetThumb(name: string, userId: number, thumb: tt.InputFile): Promise<true>;
    /**

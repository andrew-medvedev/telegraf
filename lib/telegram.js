...
const replicators = __importStar(require("./core/replicators"));
...
class Telegram extends client_1.default {
    ...
    editMessageLiveLocation(chatId, messageId, inlineMessageId, latitude, longitude, markup) {
    ...
    sendCopy(chatId, message, extra) {
        ...
        const type = Object.keys(replicators.copyMethods).find((type) => type in message);
        if (!type) {
